...
public class BinaryTreeTest {
    ...
    public void testSubSet() {
        ...
        Set<Integer> expResult = new TreeSet<>(Arrays.asList(4, 5, 6, 7));
        assertEquals(expResult, result);
        
        SortedSet result2 = tree.subSet(2, 8);
        Set<Integer> expResult2 = new TreeSet<>(Arrays.asList(2, 4, 5, 6, 7));
    ...
    public void testSet() throws IllegalArgumentException {
        ...
        SortedSet<Integer> result = tree.subSet(9, 7);
    }
}
